...
Section "MSVC Install"
  ...
  ${If} ${AtMostWin2003}
    ...
    ExecWait '"$OUTDIR\vcredist_v14_nt52_x86.exe" /quiet /norestart'
    ${If} ${RunningX64}
      File /r "vcredist_v14_nt52_x64.exe"
      ExecWait '"$OUTDIR\vcredist_v14_nt52_x64.exe" /quiet /norestart'
    ${EndIf}
  ${ElseIf} ${IsWinVista}
    File "vcredist_v14_nt60_x86.exe"
    ExecWait '"$OUTDIR\vcredist_v14_nt60_x86.exe" /quiet /norestart'
    ${If} ${RunningX64}
      File "vcredist_v14_nt60_x64.exe"
      ExecWait '"$OUTDIR\vcredist_v14_nt60_x64.exe" /quiet /norestart'
    ${EndIf}
  ${ElseIf} ${AtMostWin8}
